              ...
              <div class="product-card__img-container flex">
                ...
                ${ product.quantity === 0
                  ? `<button class="product-card__btn flex product-btn-js">
                      <svg class="cart-icon" width="18" height="17" viewBox="0 0 21 20">
            ...
            ${ product.totalQuantity === 0
              ...
              <h2 class="cart__title text-red js-cart-title">Your Cart (${product.totalQuantity})</h2>
                  ...
                  <div class="cart-total flex">
                    ...
                    <p class="cart-total__sum">$${product.totalOrderSum.toFixed(2)}</p>
                  </div>
              ...
              <article class="cart-product-container flex" data-id="${product.id}">
                <div class="cart-text-container flex">
                  ...
                  <div class="cart-item-info flex">
                    ...
                    <p class="cart-product__price">@ $${product.price.toFixed(2)}</p>
                    <p class="cart-product__total">$${(product.quantity * product.price).toFixed(2)}</p>
                  </div>
                </div>
              ...
              ${ product.map(p => `
                <div class="order-products flex">
                  ...
                  <div class="order-product-info flex">
                    <div class="cart-text-container flex">
                      <p class ="cart-product__name truncate">${p.name}</p>
                    </div>
                    <div class="cart-item-info flex">
                      <p class="cart-product__quantity">${p.quantity}x</p>
                      <p class="cart-product__price">@ $${p.price.toFixed(2)}</p>
                    </div>
                  </div>
                  <p class="cart-product__total">$${(p.quantity * p.price).toFixed(2)}</p>
                </div>
                `).join("")
              }   
                <div class="cart-total flex">
                  <p class="cart-total__text">Order total:</p>
                  <p class="cart-total__sum">$${total.totalOrderSum.toFixed(2)}</p>
                </div>
              </div>
